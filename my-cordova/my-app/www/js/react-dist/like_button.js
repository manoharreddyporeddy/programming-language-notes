...
document.querySelectorAll('.like_button_container').forEach(function (domContainer) {
  ...
  var commentID1 = parseInt(domContainer.dataset.commentid, 10);
  ReactDOM.render(React.createElement(LikeButton, { commentID: commentID1 }), // render Like custom button
