...
class Builder : public AbstractBuilder {
  public:
  //	Constructs and assembles parts to build the objects.
  void buildProductPart1(string partValue) { product.part1 = partValue; }
  void buildProductPart2(string partValue) { product.part2 = partValue; }
  void buildProductPart3(string partValue) { product.part3 = partValue; }
  void buildProductPart4(string partValue) { product.part4 = partValue; }
...
class Director {
  public:
  Director(AbstractBuilder &builder1) : builder(builder1) {}
